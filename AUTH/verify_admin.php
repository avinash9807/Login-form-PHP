<?php
// AUTH/verify_admin.php - MODERN DESIGN VERSION
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        // CASE-SENSITIVE Admin verification (Admin ya Super Admin dono access dega)
        $stmt = $conn->prepare("SELECT id, name, username, password, account_type FROM users WHERE BINARY username = ? AND account_type IN ('admin', 'super_admin')");
        ...
        if ($result->num_rows == 1) {
            ...
            if (password_verify($password, $admin['password'])) {
                // Credentials correct, redirect to create client
                $_SESSION['admin_verified'] = true;
                $_SESSION['verified_admin'] = $admin['username'];
                $_SESSION['verified_admin_name'] = $admin['name'];
                $_SESSION['verified_admin_type'] = $admin['account_type'];
                $_SESSION['verified_user_id'] = $admin['id'];
...
<head>
    ...
    <title>Verify Admin - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p class="subtitle">Enter Admin credentials to create new Client</p>
        </div>
        
        <div class="info-box">
            <strong>Admin Verification Required</strong>
            Please enter your Admin username and password to create Client accounts.
        </div>
